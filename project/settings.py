...
STATIC_ROOT = os.path.join(
    BASE_DIR, os.environ.get('STATIC_ROOT', default='static'))

REST_FRAMEWORK = {
    'DEFAULT_FILTER_BACKENDS': ['django_filters.rest_framework.DjangoFilterBackend'],
    'EXCEPTION_HANDLER': 'task_app.error_handling.custom_exception_handler',
}
...
ALLOWED_HOSTS = ENV_ALLOWED_HOSTS.split(
    ',') if ENV_ALLOWED_HOSTS is not None else []
